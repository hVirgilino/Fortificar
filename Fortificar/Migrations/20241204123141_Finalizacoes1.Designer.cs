...
namespace Fortificar.Migrations
{
    ...
    [Migration("20241204123141_Finalizacoes1")]
    partial class Finalizacoes1
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Fortificar.Models.Projeto", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Cronograma = "Teste",
                            Indicadores = "Teste",
                            InicioExecucao = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Justificativa = "Teste",
                            ObjetivoGeral = "Teste",
                            ...
                            SituacaoId = 1,
                            TerminoExecucao = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            ValorMeta = 0f
                        });
                });
            ...
            modelBuilder.Entity("Fortificar.Models.ResponsavelLegal", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CargoOSC = "Teste",
                            Endereco = "Teste",
                            MandatoVigente = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Nome = "Teste",
